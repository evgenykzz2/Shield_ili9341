...
void Shield_ili9341::StreamPixelsLo_16( uint8_t lo, uint8_t hi )
{
	TFT_DATAPIN_SET_HI(hi);
    {
        TFT_DATAPIN_SET_LO(hi); TFT_SWAP_DATA_WR TFT_DATAPIN_SET_LO(lo); TFT_SWAP_DATA_WR
        TFT_DATAPIN_SET_LO(hi); TFT_SWAP_DATA_WR TFT_DATAPIN_SET_LO(lo); TFT_SWAP_DATA_WR
        TFT_DATAPIN_SET_LO(hi); TFT_SWAP_DATA_WR TFT_DATAPIN_SET_LO(lo); TFT_SWAP_DATA_WR
        TFT_DATAPIN_SET_LO(hi); TFT_SWAP_DATA_WR TFT_DATAPIN_SET_LO(lo); TFT_SWAP_DATA_WR
...
void Shield_ili9341::StreamPixelsLo_64( uint8_t lo, uint8_t hi )
{
	TFT_DATAPIN_SET_HI(hi);
    {
        TFT_DATAPIN_SET_LO(hi); TFT_SWAP_DATA_WR TFT_DATAPIN_SET_LO(lo); TFT_SWAP_DATA_WR
...
void Shield_ili9341::StreamPixelsLo_256( uint8_t lo, uint8_t hi )
{
	TFT_DATAPIN_SET_HI(hi);
    for ( uint8_t i = 0; i < 8; ++i )
    {
...
void Shield_ili9341::StreamPixelsLo_1024( uint8_t lo, uint8_t hi )
{
	TFT_DATAPIN_SET_HI(hi);
    for ( uint8_t i = 0; i < 32; ++i )
    {
...
void Shield_ili9341::StreamPixelsHi_16( uint8_t lo, uint8_t hi )
{
	TFT_DATAPIN_SET_LO(lo);
    {
		TFT_DATAPIN_SET_HI(hi); TFT_SWAP_DATA_WR TFT_DATAPIN_SET_HI(lo); TFT_SWAP_DATA_WR
        TFT_DATAPIN_SET_HI(hi); TFT_SWAP_DATA_WR TFT_DATAPIN_SET_HI(lo); TFT_SWAP_DATA_WR
        TFT_DATAPIN_SET_HI(hi); TFT_SWAP_DATA_WR TFT_DATAPIN_SET_HI(lo); TFT_SWAP_DATA_WR
        TFT_DATAPIN_SET_HI(hi); TFT_SWAP_DATA_WR TFT_DATAPIN_SET_HI(lo); TFT_SWAP_DATA_WR
...
void Shield_ili9341::StreamPixelsHi_64( uint8_t lo, uint8_t hi )
{
	TFT_DATAPIN_SET_LO(lo);
    {
		TFT_DATAPIN_SET_HI(hi); TFT_SWAP_DATA_WR TFT_DATAPIN_SET_HI(lo); TFT_SWAP_DATA_WR
...
void Shield_ili9341::StreamPixelsHi_256( uint8_t lo, uint8_t hi )
{
	TFT_DATAPIN_SET_LO(lo);
    for ( uint8_t i = 0; i < 8; ++i )
    {
...
void Shield_ili9341::StreamPixelsHi_1024( uint8_t lo, uint8_t hi )
{
	TFT_DATAPIN_SET_LO(lo);
    for ( uint8_t i = 0; i < 32; ++i )
    {
